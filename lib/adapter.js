...
AbstractPouchDB.prototype.put =
  ...
  if (typeof this._putLocal === 'function' &&
      (this.auto_compaction || utils.isLocalId(doc._id))) {
...
AbstractPouchDB.prototype.remove =
  ...
  if (typeof this._removeLocal === 'function' &&
      (this.auto_compaction || utils.isLocalId(newDoc._id))) {
...
AbstractPouchDB.prototype.get =
  ...
  if (typeof this._getLocal === 'function' &&
      (utils.isLocalId(id) || this.auto_compaction)) {
