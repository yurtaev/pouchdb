...
function LevelPouch(opts, callback) {
  ...
  if (typeof leveldown.destroy === 'undefined') {
    leveldown.destroy = function(name, cb) { cb(null); }; // noop
  }
  ...
  api._changes = function (opts) {
    ...
    var thorughStream = through(function (data, _, next) {
      if (opts.cancelled) {
        return next();
      }
    ...
    changeStream.pipe(thorughStream);
    return {
      cancel: function () {
        opts.cancelled = true;
        if (changeListener) {
